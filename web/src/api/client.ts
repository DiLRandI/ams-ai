...
export const api = {
  ...
  insurance(assetId: number) {
    return request<VehicleInsuranceRecord[]>(
      `/api/assets/${assetId}/vehicle/insurance`,
    );
  },
  ...
  licenses(assetId: number) {
    return request<VehicleLicenseRecord[]>(
      `/api/assets/${assetId}/vehicle/licenses`,
    );
  },
  ...
  emissions(assetId: number) {
    return request<VehicleEmissionRecord[]>(
      `/api/assets/${assetId}/vehicle/emissions`,
    );
  },
